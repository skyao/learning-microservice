...
* [参考资料](reference/index.md)
    ...
    * [Building Microservices](reference/building-microservices/index.md)
        * [什么是微服务](reference/building-microservices/what-are-microservices.md)
            ...
            * [自治](reference/building-microservices/autonomous.md)
        * [关键收益](reference/building-microservices/key-benefits.md)
            * [技术多样性](reference/building-microservices/technology-heterogeneity.md)
            * [弹性](reference/building-microservices/resilience.md)